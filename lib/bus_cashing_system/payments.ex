defmodule BusCashingSystem.Payments do
  @moduledoc """
  ...
  alias BusCashingSystem.Payments.Transaction
  alias BusCashingSystem.Ticketing
...
end  # End of module BusCashingSystem.Payments
