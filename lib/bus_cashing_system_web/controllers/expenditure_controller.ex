defmodule BusCashingSystemWeb.ExpenditureController do
  ...
  def index(conn, _params) do
    ...
    expenditures = Finance.list_expenditures() |> BusCashingSystem.Repo.preload(:cashing_report)
  ...
  def show(conn, %{"id" => id}) do
    ...
    expenditure = id |> Finance.get_expenditure!() |> BusCashingSystem.Repo.preload(:cashing_report)
