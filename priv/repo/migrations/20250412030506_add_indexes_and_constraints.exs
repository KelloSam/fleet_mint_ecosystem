defmodule FleetMint.Repo.Migrations.AddIndexesAndConstraints do
  ...
  def change do
    ...
    create constraint(:cashing_reports, :expected_cashing_must_be_positive,
             check: "expected_cashing >= 0"
           )

    create constraint(:cashing_reports, :received_cashing_must_be_positive,
             check: "received_cashing >= 0"
           )
