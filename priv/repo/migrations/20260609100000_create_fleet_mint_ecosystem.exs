defmodule FleetMint.Repo.Migrations.CreateFleetMintEcosystem do
  ...
  def change do
    ...
    create table(:vehicles) do
      ...
      add :vin, :string
      # "bus" | "truck"
      add :vehicle_type, :string, null: false, default: "bus"
    ...
    create table(:bus_profiles) do
      ...
      # urban | intercity | rural | express
      add :route_type, :string, default: "urban"
    ...
    create table(:truck_profiles) do
      ...
      # rigid | articulated | tipper | flatbed | tanker
      add :truck_category, :string, default: "rigid"
    ...
    create table(:schedules) do
      ...
      # static | live
      add :validation_mode, :string, default: "static"
    ...
    create table(:bookings) do
      ...
      # cash | airtel_money | card | bank_transfer
      add :payment_method, :string, default: "cash"
    ...
    create table(:tickets) do
      ...
      add :qr_payload, :text
      add :qr_svg, :text
      # issued | boarded | cancelled | expired
    ...
    create table(:freight_trips) do
      ...
      # scheduled | loading | in_transit | delivered | cancelled
    ...
    create table(:trip_milestones) do
      ...
      # departed | checkpoint | fuel_stop | border_crossing | arrived | incident
